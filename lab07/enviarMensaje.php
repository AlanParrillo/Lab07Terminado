        ...
        "app" => [
            ...
            "data" => [
                ...
                "message" => [[
                    "time" => '1654728819',
                    "type" => 'text',
                    "value" => 'Estimado(a) su libro a sido reservado correctamente *'.strtoupper($libro->nombreLibro).' '.strtoupper($libro->genero).' '.strtoupper($libro->autor).'* Tampoco se pierda la oferta *'.strtoupper($libro->promocion).'* valido solo *'.$libro->duracion.'*'
                ]]
            ]
        ]
    ];
